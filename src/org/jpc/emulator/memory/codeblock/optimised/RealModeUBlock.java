	...
	private void fullExecute(Processor cpu) {
		...
		try {
			...
			case RDTSC:
				...
				break;
			case WRMSR:
				cpu.setMSR(reg0, (reg2 & 0xffffffffl) | ((reg1 & 0xffffffffl) << 32));
				break;
			case RDMSR:
			...
			case SETNL:
				...
				break;
			case SETNG:
				reg0 = cpu.getZeroFlag() || (cpu.getSignFlag() != cpu.getOverflowFlag()) ? 1 : 0;
				break;
			case SETG:
				reg0 = cpu.getZeroFlag() || (cpu.getSignFlag() != cpu.getOverflowFlag()) ? 0 : 1;
				break;
			...
			case LGDT_O16:
				cpu.gdtr = cpu.createDescriptorTableSegment(reg1 & 0x00ffffff, reg0);
				break;
			case LGDT_O32:
				cpu.gdtr = cpu.createDescriptorTableSegment(reg1, reg0);
				break;
			case LIDT_O16:
				cpu.idtr = cpu.createDescriptorTableSegment(reg1 & 0x00ffffff, reg0);
				break;
			case LIDT_O32:
