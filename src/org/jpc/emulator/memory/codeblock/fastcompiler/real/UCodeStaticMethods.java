...
public class UCodeStaticMethods {
	...
	public static int reg0_nef_LOAD0_FLAGS_cflag_pflag_aflag_zflag_sflag_tflag_iflag_dflag_oflag_iopl_ntflag(int cflag,
			int pflag, int aflag, int zflag, int sflag, int tflag, int iflag, int dflag, int oflag, int iopl, int ntflag) {
		int eflags = 0;
		eflags |= ntflag << 14;
		eflags |= iopl << 12;
		eflags |= oflag << 11;
	...
	public static int eip_nef_JNG_O8_eip_reg0_zflag_sflag_oflag(int eip, int reg0, boolean zflag, boolean sflag,
			boolean oflag) {
	...
	public static int eip_nef_JNG_O16_eip_reg0_zflag_sflag_oflag(int eip, int reg0, boolean zflag, boolean sflag,
			boolean oflag) {
		if(zflag || (sflag != oflag))
			return (eip + (short) reg0) & 0xffff;
		return eip;
	...
	public static int eip_nef_JG_O8_eip_reg0_zflag_sflag_oflag(int eip, int reg0, boolean zflag, boolean sflag,
			boolean oflag) {
		if((!zflag) && (sflag == oflag))
			return (eip + (byte) reg0);
		return eip;
	...
	public static int eip_nef_JG_O16_eip_reg0_zflag_sflag_oflag(int eip, int reg0, boolean zflag, boolean sflag,
			boolean oflag) {
		if((!zflag) && (sflag == oflag))
			return (eip + (short) reg0) & 0xffff;
		return eip;
	...
	public static int eax_nef_LAHF_eax_cflag_pflag_aflag_zflag_sflag(int eax, boolean cflag, boolean pflag,
			boolean aflag, boolean zflag, boolean sflag) {
		int result = 0x0200;
		if(sflag)
			result |= 0x8000;
		if(zflag)
	...
	public static void memorywrite_hef_PUSHA_A16_edi_esi_ebp_ebx_edx_ecx_eax_ss_esp(int edi, int esi, int ebp, int ebx,
			int edx, int ecx, int eax, Segment ss, int esp) {
	...
	// // while (count != 0)
	// // {
	// // es.setDoubleWord(inAddr & 0xffff, seg0.getDoubleWord(outAddr &
	// 0xffff));
	// // count--;
	// // outAddr -= 4;
	// // inAddr -= 4;
	...
	public static void memorywrite_hef_REP_MOVSW_A16_dflag_es_edi_seg0_esi_ecx(boolean dflag, Segment es, int edi,
			Segment seg0, int esi, int ecx) {
		int count = ecx & 0xffff;
		int inAddr = edi & 0xffff;
		int outAddr = esi & 0xffff;
	...
	public static void memorywrite_hef_REP_STOSW_A16_dflag_reg0_es_edi_ecx(boolean dflag, int reg0, Segment es,
			int edi, int ecx) {
		int count = ecx & 0xffff;
		int addr = edi & 0xffff;
	...
	public static int esp_nef_ENTER_O16_A16_esp_reg0_reg1(int esp, int reg0, int reg1) {
		...
		// return (esp & ~0xffff) | ((esp - (reg0 + (((reg1 % 32) + 1) << 2))) &
		// 0xffff);
	}
	...
	public static void memorywrite_hef_INT_O16_A16_eip_esp_ss_cflag_pflag_aflag_zflag_sflag_tflag_iflag_dflag_oflag_iopl_ntflag(
			int eip, int esp, Segment ss, int cflag, int pflag, int aflag, int zflag, int sflag, int tflag, int iflag,
			int dflag, int oflag, int iopl, int ntflag) {
		int eflags = 0;
		eflags |= ntflag << 14;
		eflags |= iopl << 12;
		eflags |= oflag << 11;
