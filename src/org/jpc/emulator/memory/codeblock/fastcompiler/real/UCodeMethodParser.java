...
public class UCodeMethodParser implements MicrocodeSet {
	...
	public UCodeMethodParser(Object[][][] operations, int[][][] operandArray, boolean[][] externalEffectsArray,
			boolean[][] explicitThrowArray) {
	...
	private void insertIntoFragmentArrays(String uCodeName, String resultName, String[] args, boolean externalEffect,
			boolean explicitThrow, Vector instructions) {
		try {
	...
	// UCodeMethodParser p = new UCodeMethodParser(new
	// Object[MICROCODE_LIMIT][FASTCompiler.ELEMENT_COUNT][],
