...
public class DMAController implements IOPortCapable, HardwareComponent {
	...
	private static final int CMD_NOT_SUPPORTED = CMD_MEMORY_TO_MEMORY | CMD_FIXED_ADDRESS | CMD_COMPRESSED_TIME
			| CMD_CYCLIC_PRIORITY | CMD_EXTENDED_WRITE | CMD_LOW_DREQ | CMD_LOW_DACK;
	...
	private void runChannel(int channelNumber) {
		DMARegister r = dmaRegs[channelNumber];
		int n = r.transferDevice.transferHandler(channelNumber + (controllerNumber << 2), r.nowCount,
